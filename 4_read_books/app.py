...
# dot.node("ask_question")
# dot.node("embed_relevant_documents")
# dot.node("retrieve_relevant_documents")
# dot.node("prepare_question")
# dot.node("answer_question")
# dot.edge("ask_question", "embed_relevant_documents")
# dot.edge("embed_relevant_documents", "retrieve_relevant_documents")
# dot.edge("retrieve_relevant_documents", "prepare_question")
# dot.edge("prepare_question", "answer_question")
# dot.render("./4_read_books/app", view=True)
